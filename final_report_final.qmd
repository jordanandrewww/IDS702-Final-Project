...
```{r, fig.cap="Diagnostic plots for the raw RQ1 model."}
par(mfrow = c(2, 2))
plot(model_rq1_raw)
par(mfrow = c(1, 1))
```
...
```{r fig.cap="Diagnostic plots for the raw RQ1 model.", fig.width=4, fig.height=3}
...
```{r, fig.cap="Diagnostic plots for the log-transformed RQ1 model.", fig.align='center'}
...
```{r, fig.cap="Influential Points Measured by Cook's Distance.", fig.align='center', fig.width=4, fig.height=3}
