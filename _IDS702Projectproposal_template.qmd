...
Link: <https://www.kaggle.com/datasets/ayeshasiddiqa123/cars-pre?resource=download>

**Brief description:**

This dataset is a large flight-pricing dataset scraped from the online travel agency EaseMyTrip.com. The data was collected between February 11 and March 31st of 2022, using the Octoparse web-scraping tool and contains 300,153 unique flight booking options for travel between India's 6 major metropolitan cities. The data consists of both economy and business-class listings, which were collected separately and then merged into a single cleaned dataset. The dataset contains columns like airline, source city, class, flight duration, and price.
