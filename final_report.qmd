...
# ------------------------------------------------------------
# MODEL C — Log model + Removing outlier observations
# ------------------------------------------------------------
...
For RQ1, we first fit a linear regression model using the raw outcome, Hours of music listening per day. Standard diagnostic plots for this initial model (residuals versus fitted values and the normal Q–Q plot; it showed clear right–skew and heteroscedasticity in the residuals, driven largely by a small number of participants with very high listening times. The histogram of Hours per day also confirmed that the outcome was highly right–skewed. Together, these diagnostics suggested that the linearity and constant–variance assumptions were not well satisfied on the original scale.
