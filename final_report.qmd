...
```{r, fig.cap="Daily Listening Time vs. Depression Score by Streaming Platform."}
...
```{r, fig.cap="Table 1: Significant Predictors from RQ1 Linear Model."}
library(broom)
library(kableExtra)
library(dplyr)
...
These results show that log-transformed listening hours are shaped by depression symptoms, platform behavior, work context, and musical identity traits.
...
```{r, fig.cap="Figure 5: Influential Points Measured by Cook's Distance.", fig.align='center'}
